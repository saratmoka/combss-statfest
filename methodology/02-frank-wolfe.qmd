...
The outer problem $$\min_{\boldsymbol{t} \in \mathcal{T}_k} f_\delta(\boldsymbol{t})$$ is a smooth optimisation, but $f_\delta$ is itself the value of an *inner* minimisation over $\boldsymbol{\beta}$: recall that 
$$
