...
$$
\begin{aligned}
&\min_{\beta_0,\,\boldsymbol{\beta},\,\boldsymbol{z}}\;\; -\tfrac{1}{n}\,\ell(\beta_0, \boldsymbol{\beta}) \\
&\text{subject to} \quad z_j \in \{0,1\},\quad \textstyle\sum_j z_j \le k,\quad |\beta_j| \le M z_j.
\end{aligned}
$$
