...
- [`handout-r.pdf`](handouts/handout-r.pdf) — R quick-start (conda env, R inside the env, RStudio Desktop, Demos 1–4)
- [`handout-python.pdf`](handouts/handout-python.pdf) — Python quick-start (same env, Spyder, Demos 1–4 with the v2 API)
